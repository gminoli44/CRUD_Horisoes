...
import conexion.Docentes;
import controlador.util.JsfUtil;
import controlador.util.JsfUtil.PersistAction;
import entidades.DocentesFacade;
...
public class DocentesController implements Serializable {
    ...
    @EJB
    private entidades.DocentesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/utilidades/Bundle").getString("DocentesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/utilidades/Bundle").getString("DocentesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/utilidades/Bundle").getString("DocentesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
