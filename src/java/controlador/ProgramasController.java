...
import conexion.Programas;
import controlador.util.JsfUtil;
import controlador.util.JsfUtil.PersistAction;
import entidades.ProgramasFacade;
...
public class ProgramasController implements Serializable {
    ...
    @EJB
    private entidades.ProgramasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/utilidades/Bundle").getString("ProgramasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/utilidades/Bundle").getString("ProgramasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/utilidades/Bundle").getString("ProgramasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
